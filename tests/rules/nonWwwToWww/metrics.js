...
export default function() {
    group("metrics", function() {
        ...
        let result = check(res, {
            ...
            "body contains from wyrihaximus.net => GET => www.wyrihaximus.net": (r) => r.body.includes('http_requests_total{') && r.body.includes('fromHost="wyrihaximus.net"') && r.body.includes('method="GET"') && r.body.includes('toHost="www.wyrihaximus.net"'),
